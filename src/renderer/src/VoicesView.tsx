...
import { TTSProject, VoiceProfile, generateId, ACCENT_PRESETS } from './types'
...
export default function VoicesView({ project, updateProject }: Props): JSX.Element {
  ...
  useEffect(() => {
    // Load system voices when TTS is ready
    ...
    loadVoices()
    window.api.onTTSReady(() => loadVoices())
  }, [])
