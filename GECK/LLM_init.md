# Project: TTS-Soundboard

**Repository:** https://github.com/crussella0129/TTS-Soundboard
**Local Path:** C:/Users/charl/TTS-Soundboard
**Created:** 2026-02-04
...
- **Frameworks:** Electron, Tauri, Qt, WPF, WinForms, GTK, PyQt, wxWidgets, .NET MAUI
- **Must use:** Native platform conventions, proper window lifecycle, system theme support, accessible UI
- **Must avoid:** Excessive resource usage, blocking UI thread, platform-specific code without abstraction
...
DialogueAsset (conceptual schema - which can also be uploaded with pre-completed dialogue and batch processed):
